...
func NewTestContainerWrapper(t *testing.T, test *Test, opts ...TestContainerWrapperSettingsOpts) *TestContainerWrapper {
	...
	testContainer.generatePrivateKey(t)
...
func (c *TestContainerWrapper) generatePrivateKey(t *testing.T) {
...
func WithVolumes(v []Volume) TestContainerWrapperSettingsOpts {
	return func(s *TestContainerWrapperSettings) {
		s.ContainerSettings.AdditionalVolumes = append(s.ContainerSettings.AdditionalVolumes, v...)
	}
}
